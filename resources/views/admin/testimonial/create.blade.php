                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 pb-1">
                                ...
                                <div class="">
                                    <input type="text" name="client_name" required class="form-control form-control-sm w-100" placeholder="Client Name">
                                </div>
                            </div>
                            <div class="col-md-6 pb-1">
                                <div class="row">
                            ...
                            <div class="col-md-6 pb-1">
                                ...
                                <div class="">
                                    <textarea name="comment" rows="5" class="form-control form-control-sm w-100"></textarea> 
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 pb-1">
                                ...
                                <div class="row">
                                    <div class="col-md-3 pl-4">
                                        <input type="radio" name="status" value="1" required class="form-check-input" id="active"  checked>
