...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                <form method="POST" action="{{route('admin.scholarship-or-award.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 pb-1">
                                ...
                                <div class="">
                                    <input type="text" name="name" required class="form-control form-control-sm w-100" placeholder="Scholarship/Award Name">
                                </div>
                            </div>
                            <div class="col-md-6 pb-1">
                                <label class="control-label mb-0">Scholarship/Award Title <span class="text-danger">*</span></label>
                                <div class="">
                                    <input type="text" name="title" required class="form-control form-control-sm w-100" placeholder="Scholarship/Award Title">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 pb-1">
                                ...
                                <div class="">
                                    <input type="text" name="institution" required class="form-control form-control-sm w-100" placeholder="Institution Name">
                                </div>
                            </div>
                            <div class="col-md-6 pb-1">
                                <label class="control-label mb-0">Wining Year <span class="text-danger">*</span></label>
                                <div class="">
                                    <input type="text" name="win_year" required class="form-control form-control-sm w-100" placeholder="Passing Year">
                                </div>
                            </div>
